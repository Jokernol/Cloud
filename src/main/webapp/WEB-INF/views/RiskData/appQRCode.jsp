                ...
                <form method="POST" action="${pageContext.request.contextPath}/user/regist">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input value="是" class="form-check-input" type="radio" name="temperature" id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                 是
                            </label>
                        </div>
                        <div class="form-check">
                            <input value="没有" class="form-check-input" type="radio" name="temperature" id="flexRadioDefault2" checked>
